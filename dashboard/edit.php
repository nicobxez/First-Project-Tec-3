  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"><!--Cuerpo de la pagina-->
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Editar Artículo</h1><?php echo $message_out; ?>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a class="btn btn-sm btn-outline-secondary" href="dashboard.php">Volver</a>
          </div>

          <form enctype="multipart/form-data" action="../functions/article/update.php" method="POST"><!--Formulario Noticias-->
            <div class="btn-group mr-2">
        ...
        <div class="form-group col-md-7">
          ...
          <textarea name="content" class="form-control" id="content" rows="3" placeholder="Escriba aquí la noticia."></textarea>
        </div>
        <div class="form-group col-md-7">

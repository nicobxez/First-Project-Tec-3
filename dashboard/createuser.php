...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>EEST3 | Nuevo Usuario</title>
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"><!--Cuerpo de la pagina-->
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Nuevo Usuario</h1><?php echo $message_out; ?>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a class="btn btn-sm btn-outline-secondary" href="dashboard.php">Volver</a>
          </div>

          <form action="../functions/userc/insert.php" method="POST"><!--Formulario Noticias-->
            <div class="btn-group mr-2">
              &nbsp;&nbsp;<button type="submit" name="submit" class="btn btn-sm btn-outline-secondary">Crear</button>
            </div>
          </div>
        </div>
        ...
        <div class="form-group col-md-7">
          ...
          <input type="email" name="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Correo Electronico" required>
        </div>
        <div class="form-group col-md-7">
          <label for="user"><i class="fas fa-user-plus"></i>&nbsp;Nombre</label>
          <input type="text" name="user" class="form-control" id="user" aria-describedby="emailHelp" placeholder="Nombre" required>
        </div>
        <div class="form-group col-md-7">
          <label for="categorie"><i class="fas fa-id-badge" style="height:16px; width: 12px;"></i>&nbsp;Seleccionar Autoridad</label>
        ...
        <div class="form-group col-md-7">
          <label for="pass"><i class="fas fa-key"></i></i>&nbsp;Contraseña</label>
          <input type="password" name="pass" class="form-control" id="pass" aria-describedby="emailHelp" placeholder="Contraseña" required>
        </div>
        <div class="form-group col-md-7">
          <label for="cpass"><i class="fas fa-unlock-alt"></i>&nbsp;Confirmar Contraseña</label>
          <input type="password" name="cpass" class="form-control" id="cpass" aria-describedby="emailHelp" placeholder="Confirmar Contraseña" required>
        </div>
        </form>
